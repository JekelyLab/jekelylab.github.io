...
footer: <@jekely@biologists.social>
---
...
## Pressure-responding ciliated sensory neurons
...
## UV-sensing brain ciliary photoreceptors (cPRCs)

![](images/pressure/c_opsin1.png){.absolute top="150" left="0" width="400"}

![](images/pressure/c_opsin_KO_calcium.png){.absolute top="147" left="450" height="450"}
