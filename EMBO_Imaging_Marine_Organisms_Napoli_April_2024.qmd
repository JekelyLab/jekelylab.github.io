---
title: "Whole-body volume EM and synaptic connectome of a segmented marine annelid larva"
subtitle: "EMBO Lecture Course Imaging Marine Organisms Across Scales<br>09 – 12 April 2024 | Napoli, Italy"
...
![](images/cos_symposium_2024-life_in_context.png){height=600}

## Mastodon - take back control of social media

::: columns
::: {.column width="20%"}
![](images/qr_code_mastodon_invitation.png)
...
- non-corporate, federated, free
- no adds
- institutions/organisations can self-host their server
- no crazy billionaires can ever take it over (to destroy it)
...
![](movies/brain_Video2.webm){height=550}
...
::: columns
:::{.column width="50%"}
![](movies/high_speed_cilia.webm){width=58%}
